      ...
      <FadeIn>
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-[var(--text-muted)] mt-2">Sign in to access your personalized news feed</p>
          </div>
          ...
          <div className="relative mb-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-[var(--bg-primary)] text-[var(--text-muted)]">or continue with email</span>
            </div>
          </div>
          ...
          <p className="text-center mt-6 text-[var(--text-muted)]">
            ...
            <Link href="/signup" className="text-et-red hover:underline font-medium">
              Sign up
            </Link>
          </p>
        </div>
