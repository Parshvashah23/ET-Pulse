  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 w-full animate-in fade-in duration-500">
      ...
      <div className="mb-8 border-b border-[var(--border)] pb-6">
        <h1 className="text-3xl md:text-4xl font-bold font-serif text-[var(--text-primary)] mb-4 leading-tight">
          {query}
        </h1>
        <div className="flex justify-between items-center bg-[var(--surface)] p-3 rounded-lg border border-[var(--border)] shadow-sm">
          <PersonaSwitcher 
