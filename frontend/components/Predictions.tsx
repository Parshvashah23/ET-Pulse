...
export default function Predictions({ predictions }: PredictionsProps) {
  ...
  return (
    <div className="bg-[var(--surface)] rounded-xl border border-[var(--border)] p-6">
      <h3 className="text-lg font-bold text-[var(--text-primary)] mb-4">Forward Signals</h3>
        ...
        {predictions.map((pred, i) => {
          ...
          return (
            ...
            >
              ...
              <h4 className="font-bold text-sm text-[var(--text-primary)] mb-2 leading-snug">
                {pred.signal}
              </h4>
              ...
              <div className="flex items-center gap-2 text-[10px] text-[var(--text-secondary)]">
                <span className="bg-[var(--surface)]/60 px-2 py-0.5 rounded-full flex items-center gap-1">
                  <Clock className="w-3 h-3" /> {pred.timeframe}
                </span>
                <span className="bg-[var(--surface)]/60 px-2 py-0.5 rounded-full capitalize">
                  {pred.impact_area}
                </span>
              </div>
            </div>
